...
import { BoundedCondition, Condition, LatLngDist, MapBounds, WayId, WaysConditions } from 'src/models';
...
export class RCService 
{
    ...
    // async getTestQ(col : string): Promise<string[]>
    // {
    //     return await testTables(this.knex)
    //         .select( 'data' )
    //         .where( { 'data': col} )
    // }
